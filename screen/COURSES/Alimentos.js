      ...
      <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.description}>
            ...
            {/* Lista de Cursos */}
            <TouchableOpacity style={styles.courseItem} onPress={() => handleCoursePress('Alimentos Funcionais')}>
              <View style={styles.sideBar3}></View> 
              <Image source={img1} style={styles.courseImage} />
              <View style={styles.courseTextContainer}>
                <Text style={styles.courseTitle}>Alimentos Funcionais</Text>
                <Text style={styles.courseSubtitle}>O curso de Aperfeiçoamento Profissional de Alimentos Funcionais tem por objetivo o desenvolvimento de capacidades...</Text>
              </View>
            </TouchableOpacity>
