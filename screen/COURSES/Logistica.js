      ...
      <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Text style={styles.description}>
            Os cursos do SENAI-SP nas áreas de Logística e Transporte abrangem: Programador de Produção, Auxiliar de Almoxarife, Operador de Logística, entre outros.
          </Text>
            {/* Lista de Cursos */}

            <TouchableOpacity style={styles.courseItem} onPress={() => handleCoursePress('Desvendando o 5G')}>
              <View style={styles.sideBar3}></View> 
              <Image source={img1} style={styles.courseImage} />
              <View style={styles.courseTextContainer}>
                <Text style={styles.courseTitle}>Desvendando o 5G</Text>
                <Text style={styles.courseSubtitle}>O curso de Aperfeiçoamento Profissional Desvendando o 5G, tem por objetivo apresentar os principais conceitos sobre a tecnologia 5G, seu potencial e impacto na sociedade...</Text>
              </View>
            </TouchableOpacity>
