...
import img1 from "../../assets/Construction.png";
  ...
  useEffect(() => {
    const fetchCursos = async () => {
      try {
        ...
        const response = await axios.get('http://10.0.2.2:3000/api/cursos/topico/Construção Civil');
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.titleContainer}>
            <Text style={styles.title}>Construção Civil</Text>
            <Ionicons name="hammer-outline" size={50} color="#795548" style={styles.icon} />
          </View>
          <Text style={styles.description}>
            Os cursos do SENAI-SP na área de Construção Civil abrangem: Pedreiro, 
            Instalações Elétricas, Desenho de Projetos e muito mais.
          </Text>
